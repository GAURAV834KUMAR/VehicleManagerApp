...
class MyTrucksWidget extends StatefulWidget {
  const MyTrucksWidget({Key? key}) : super(key: key);

  @override
  _MyTrucksWidgetState createState() => _MyTrucksWidgetState();
}

class _MyTrucksWidgetState extends State<MyTrucksWidget> {
