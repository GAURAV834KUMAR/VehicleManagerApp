...
class AddTruckWidget extends StatefulWidget {
  const AddTruckWidget({Key? key}) : super(key: key);
...
class _AddTruckWidgetState extends State<AddTruckWidget>
  ...
  TextEditingController? bodyLengthController;
  ...
  void initState() {
    ...
    bodyLengthController = TextEditingController(text: '0');
    capacityController = TextEditingController(text: '0');
                ...
                children: [
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Capacity (Tonne)',
                                hintText: 'Capacity (Tonne)',
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: bodyLengthController!
                                        .text.isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Truck Registration No.*',
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await CreateTruckCall.call(
                                stype: 'Create',
                                userRefId: valueOrDefault(
                                    currentUserDocument?.userId, 0),
                                truckRegNo: textController3!.text,
                                truckType: FFAppState().TruckType,
                                capacity: int.parse(capacityController!.text),
                                bodyLn: int.parse(bodyLengthController!.text),
                                trOwRefId: getJsonField(
                                  FFAppState().TruckOwnerId,
                                  r'''$..tr_ow_id''',
                                ),
                                ownertype: FFAppState().OwnerType,
                              );
                              await Navigator.pushAndRemoveUntil(
                                context,
                                PageTransition(
