...
class TruckExpenseBeforeCreateWidget extends StatefulWidget {
  const TruckExpenseBeforeCreateWidget({Key? key}) : super(key: key);

  @override
  _TruckExpenseBeforeCreateWidgetState createState() =>
      _TruckExpenseBeforeCreateWidgetState();
}

class _TruckExpenseBeforeCreateWidgetState
    extends State<TruckExpenseBeforeCreateWidget>
