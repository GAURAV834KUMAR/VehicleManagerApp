...
import '../truck_no/truck_no_widget.dart';
...
class _AddTripWidgetState extends State<AddTripWidget>
  ...
  TextEditingController? rateMoreController;
  TextEditingController? totalMoreController;
  TextEditingController? freightController;
  TextEditingController? rateController;
  TextEditingController? totalController;
  TextEditingController? textController1;
  TextEditingController? textController2;
  TextEditingController? lRNoController;
  ...
  void initState() {
    ...
    freightController = TextEditingController(text: '0');
    rateController = TextEditingController(text: '0');
    totalController = TextEditingController(text: '0');
    rateMoreController = TextEditingController(text: '0');
    totalMoreController = TextEditingController(text: '0');
    textController1 = TextEditingController();
    textController2 = TextEditingController();
    lRNoController = TextEditingController(text: '0');
    materialController = TextEditingController(text: '--');
    startKMController = TextEditingController(text: '0');
    textController11 = TextEditingController(text: '--');
  }
  ...
  void dispose() {
    ...
    rateMoreController?.dispose();
    totalMoreController?.dispose();
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              children: [
                                if (functions.billTypeNotVisible(
                                        FFAppState().BillingType) ==
                                    0)
                                  InkWell(
                                    onTap: () async {
                                      setState(() =>
                                          FFAppState().BillingType = 'Fixed');
                                    },
                                    child: Container(
                                      width: 116,
                                      height: 50,
                                ...
                                if (functions.billTypeNotVisiblePer(
                                        FFAppState().BillingType) ==
                                    1)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                ...
                                if (functions.billTypeNotVisible(
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        setState(() =>
                                            FFAppState().BillVisible = 'More');
                                        setState(() => FFAppState()
                                            .BillingType = dropDownValue!);
                                      },
                                      child: Container(
                                        width: 116,
                                        height: 50,
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      labelText:
                                                          'Total${functions.stringAfter3(dropDownValue)} Nos',
                                                      labelStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyText1
                        ...
                        if (functions
                                .moreDetails(FFAppState().AddMoreDetails) ==
                            false)
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(10, 10, 10, 0),
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon:
                                          lRNoController!.text.isNotEmpty
                                              ? InkWell(
                                                  onTap: () async {
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon:
                                          textController11!.text.isNotEmpty
                                              ? InkWell(
                                                  onTap: () async {
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            addTrip = await CreateTripCall.call(
                              stype: 'Create',
                              userRefId: valueOrDefault(
                                  currentUserDocument?.userId, 0),
                              trRefId: FFAppState().TruckId,
                              cusName: FFAppState().CusName,
                              routeOrigin: textController1!.text,
                              routeDestination: textController2!.text,
                              partyBillType: FFAppState().BillingType,
                              startDate: dateTimeFormat('yMd', datePicked),
                              startKm: int.parse(startKMController!.text),
                              ratePer: int.parse(rateController!.text),
                              freightAmt: functions.freight(
                                  int.parse(rateController!.text),
                                  int.parse(totalController!.text),
                                  int.parse(freightController!.text)),
                              lrNo: int.parse(lRNoController!.text),
                              materialName: materialController!.text,
                              notes: textController11!.text,
                              cusRefId: FFAppState().CusId,
                              total: int.parse(totalController!.text),
                              truckRegNo: FFAppState().TruckRegNo,
                              tiListType: 1,
                            );
                            await UpdateAfterCreateTruckListTypeCall.call(
                              stype: 'UpdateTruckListType',
                              trId: FFAppState().TruckId,
                            );
                            await Navigator.pushAndRemoveUntil(
                              context,
                              PageTransition(
