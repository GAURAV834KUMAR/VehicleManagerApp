...
class ConformTruckExpenseTypeWidget extends StatefulWidget {
  const ConformTruckExpenseTypeWidget({Key? key}) : super(key: key);

  @override
  _ConformTruckExpenseTypeWidgetState createState() =>
      _ConformTruckExpenseTypeWidgetState();
}

class _ConformTruckExpenseTypeWidgetState
    extends State<ConformTruckExpenseTypeWidget> {
            ...
            child: FFButtonWidget(
              onPressed: () async {
                addTruckRegNo = await CreateTruckExpenseByTypeCall.call(
                  ...
                  exType: truckRegNoController!.text,
                );
