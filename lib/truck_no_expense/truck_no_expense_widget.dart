...
class TruckNoExpenseWidget extends StatefulWidget {
  const TruckNoExpenseWidget({Key? key}) : super(key: key);

  @override
  _TruckNoExpenseWidgetState createState() => _TruckNoExpenseWidgetState();
}

class _TruckNoExpenseWidgetState extends State<TruckNoExpenseWidget> {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        return InkWell(
                                          onTap: () async {
                                            setState(() => FFAppState()
                                                    .TruckRegNo = getJsonField(
                                                  availableTruckListItem,
                                                  r'''$..truck_reg_no''',
                                                ).toString());
                                            setState(() => FFAppState()
                                                    .TruckId = getJsonField(
                                                  availableTruckListItem,
                                                  r'''$..tr_id''',
                                                ));
